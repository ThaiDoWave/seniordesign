...
public class MidiConversion {
    ...
    public static void Convert(String SongName) throws Exception {

        // THIS IS WHERE YOU PUT THE SONG. APPARENTLY NEEDS .MIDI and .MID WTF! Currently using this for hot cross buns.
        Sequence sequence = MidiSystem.getSequence(new File(SongName));
        PrintWriter out = new PrintWriter(new FileWriter("Conversion.txt"));
