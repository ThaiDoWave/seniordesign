...
public class DumpReceiver implements	Receiver
{
	    ...
	    boolean bPrintTimeStampAsTicks) 
	{
        ...
        public DumpReceiver (boolean bPrintTimeStampAsTicks) throws FileNotFoundException{
            m_printStream = new PrintStream(new FileOutputStream("whatever.txt", true),
                                   true);
		m_bDebug = false;
		m_bPrintTimeStampAsTicks = bPrintTimeStampAsTicks;
        }
	...
	public void send(MidiMessage message, long lTimeStamp)
	{
		...
		System.out.println("time"+strTimeStamp+"message"+ strMessage);
